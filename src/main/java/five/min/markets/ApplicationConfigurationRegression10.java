...
public class ApplicationConfigurationRegression10 {
	...
	RegressionFeature regressionSlope10(MarketDataFeatureRepository marketDataFeatureRepository, MarketDataRepository marketDataRepository,
		...
		return new RegressionFeature(FeatureType.REGRESSION_SLOPE_10, marketDataFeatureRepository,marketDataRepository, objectPoolFactory);
	}
	...
	FeatureMapper upTrendRegression10Feature(MarketDataFeatureRepository marketDataFeatureRepository,
		...
		return new RegressionTrendFeature(marketDataFeatureRepository, 
				...
				FeatureType.REGRESSION_SLOPE_10, objectPoolFactory);
	}
